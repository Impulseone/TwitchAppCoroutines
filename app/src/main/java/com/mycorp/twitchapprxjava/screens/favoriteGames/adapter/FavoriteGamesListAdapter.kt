...
import com.mycorp.twitchapprxjava.common.helpers.ItemData
import com.mycorp.twitchapprxjava.models.FavoriteGameData

class FavoriteGamesListAdapter :
    PagedListAdapter<FavoriteGameData, FavoriteGameViewHolder>(BaseItemCallback<ItemData<FavoriteGameData>>()) {
